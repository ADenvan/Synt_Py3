task_ai_fund = [
    {"id": 0, "question": "", "data": ["", "", None], "teg": [""], "helper": None},
    {
        "id": 1,
    ...
    },
    {
        ...
        "data": [
            "Файл text.txt с содержимым: Hello world Python is great",
            "(2,5)",
            None,
        ],
        "teg": ["file", "open", "txt"],
    ...
    },
    {
        ...
        "data": [
            "in-order (левый узел → корень → правый узел).",
            "[4, 2, 5, 1, 3]",
            None,
        ],
    ...
    },
    {
        ...
        "data": [
            ...
            " После загрузки из файла должен вернуться исходный словарь.",
            None,
        ],
    ...
    },
    {
        ...
        "data": [
            "Успешный случай: a = 10, b = 2.Ошибка деления: a = 5, b = 0.Ошибка типа: a = 10, b = 2.",
            "5.0-Деление на ноль невозможно-Некорректный тип данных",
            None,
        ],
        "teg": ["easy", "except"],
        "helper": None,
...
# class LinkedList
    ...
    },
    {
        ...
        "data": [
            "email = user@example.com (валидный) email = invalid_email (невалидный)",
            "Ожидаемый результат: True и False",
            None,
        ],
        "teg": ["easy", "re", "pattern"],
        "helper": None,
    ...
    },
    {
        ...
        "data": [
            "nums = [5, 2, 9, 1, 5, 6]",
            "Ожидаемый результат: [1, 2, 5, 5, 6, 9].",
            None,
        ],
    ...
    },
    {
        ...
        "data": [
            "Входные данные: n = 5.",
            "Ожидаемый результат: Последовательность 1, 4, 9, 16, 25.",
            None,
        ],
    ...
    },
    {
        ...
        "data": [
            "Входные данные: URL https://jsonplaceholder.typicode.com/todos/1.",
            "Вывод данных задачи (например, {'userId': 1, 'id': 1, ...}).",
            None,
        ],
        "teg": ["easy", "requests"],
        "helper": None,
